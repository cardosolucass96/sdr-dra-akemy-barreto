...
_PROMPT_DEFINITIONS = {
    ...
    WHATSAPP_STYLE_PROMPT_NAME: TextPromptDefinition(
        ...
        prompt=(
            ...
            "request.\n"
            "Give each message one coherent main job. Use a blank line when the next thought "
            "should arrive as a separate WhatsApp message, especially for an independent "
            "follow-up question. Keep only closely related copyable facts or a compact list "
            "together in one message, using single line breaks inside that message.\n"
            ...
            "Prefer a few short messages over one long message with several paragraph breaks.\n"
